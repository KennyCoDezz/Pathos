...
import bgImage from '../assets/moonlit.jpg'
    ...
    return (
      <ImageBackground source={bgImage} style={styles.backgroundContainer}>
        ...
        <TouchableOpacity style={styles.eyeBtn} >
          ...
          <TouchableOpacity style={styles.logBtn} onPress={()=>navigation.navigate('HomepageScreen')}>
        ...
        <View style={styles.crtAcc}>
                ...
                <TouchableOpacity onPress={()=>navigation.navigate('Signup')}>
                  <Text style={styles.regHere} >Register Here </Text>
                </TouchableOpacity>
