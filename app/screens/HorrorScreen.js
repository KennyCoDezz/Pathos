        ...
        <View style={styles.background}> 
            <View style={styles.header}>
                ...
                <View style={styles.headerTextContainer}>
                    <Text style={{fontFamily: 'SectionTitle', fontSize: 27, color: colors.white}}>Horror</Text>
                </View>
            </View>
            <ScrollView style={styles.scrollView} contentContainerStyle={{alignItems:'center'}}>
                <View style={styles.scrollViewBanner}>
                    <Image source={require('../assets/Image/horror-banner.png')} style={styles.scrollViewBannerImage}></Image>
                </View>
...
const styles = StyleSheet.create({
    ...
    header: {
        backgroundColor: colors.horror_headerBackgroundColor,
        height: 120,
        width: '100%',
    },
    backButton: {
